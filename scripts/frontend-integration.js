 ...
 * This file demonstrates how to integrate Farmgateway with a web frontend
 */

// For React/Vue/Angular applications
export class FarmgatewayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FarmgatewayClient(provider, contractAddress);
