...
const contractABI = require("../artifacts/contracts/Farmgateway.sol/Farmgateway.json").abi;

program
    .name("farmgateway-cli")
    .description("CLI tool for Farmgateway smart contract")
    .version("1.0.0");
